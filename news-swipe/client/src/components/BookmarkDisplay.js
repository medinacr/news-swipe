    ...
    <div className="bookmark-bar">
      ...
      {user.bookmark ? user.bookmark.map((data, _index) =>
        <div className="bookmark-card">
          <img className="bookmark-image" alt="https://t3.ftcdn.net/jpg/04/34/72/82/240_F_434728286_OWQQvAFoXZLdGHlObozsolNeuSxhpr84.jpg" src={data.urlToImage || 'https://static.projects.iq.harvard.edu/files/styles/os_files_xxlarge/public/torman_demo1/files/nature-hollywood.jpg?m=1519841272&itok=3RYGrGr8'}></img>
